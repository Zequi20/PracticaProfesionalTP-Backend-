...
from .views import ClienteView, ReservaView, CiudadView, DepartamentoView, HabitacionView, HotelView, PersonalView, ServicioView , ResenaView, LoginView
...
urlpatterns = [
    ...
    path('reservas', ReservaView.as_view(), name='api-reservas'),
